...
public class StatisticsSchemaService {
    ...
    public StatisticsSchemaService(final StatisticsSchemaDao schemaDao, final MainCategoryProvider mainCategoryProvider, final SubCategoryProvider subCategoryProvider) {
    ...
    private void validateCategories(final StatisticsSchema schema, final Long userId) {
        if (schema.getMainCategory() != null) {
            List<MainCategory> mainCategoryList = mainCategoryProvider.provide(TransactionType.OUTCOME, userId);
        ...
        if (schema.getSubCategory() != null) {
            List<SubCategory> subCategoryList = subCategoryProvider.provide(TransactionType.OUTCOME, userId);
